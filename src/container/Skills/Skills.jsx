...
const skills = [
  ...
  { title: 'Spring Boot', imgUrl: images.springBoot},
...
const experiences = [
  { title: 'Software Engineer', year: '2023', company: 'Virtomat', description: 'I contributed in the development of the Virtomat website using React and in linking the Strapi backend.'},
  { title: 'Software Engineer', year: '2022', company: 'ENSO Artificial Intelligence', description: 'I assisted and collaborated with EnsoAI to explore different company areas, like project management and software programming.'},
]
